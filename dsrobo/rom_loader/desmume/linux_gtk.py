...
from pyatspi import Accessible, Registry
...
from dsrobo.util.linux_gtk import find_window_by_exact_name, open_file_using_ctrl_l, send_keys


class DeSmuMERomLoader(RomLoaderBase):

    def load_rom(self, application: Accessible,
        ...
        _, main_window_name = config.desmume.main_window_name.split('.', maxsplit=1)
